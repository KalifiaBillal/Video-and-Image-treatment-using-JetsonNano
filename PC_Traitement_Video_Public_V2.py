...
# Titre programme
titre = "Traitement Video PC V1.1 Python OpenCVCUDA - Copyright Alain PAILLOU 2018-2020"
...
#        start_time = time.time()        
        ...
        if flag_noir_blanc == 1 or flag_colour_camera == False :
            ...
            # UnsharpMask CUDA
            if flag_2DConv == 1 or flag_sharpen_soft1 == 1 or flag_gaussian == 1 or flag_unsharp_mask == 1 :
                nb_blocksX = (width // nb_ThreadsX) + 1
                nb_blocksY = (height // nb_ThreadsY) + 1
